...
| --- | --- | --- | --- |
| `perf-scale/` | Parallel scan, incremental cache, mmap I/O, bench ledger | T-01..T-04 | done |
| `ux-reporting/` | HTML report, `diff`, `stats`, `doctor`, `watch`, stdin, pwsh completion, scan aggregation, baseline v2 | T-01..T-09 | done |
| `repair-engine/` | Plan export/apply, batch repair, structural diff preview, new recipes | T-01..T-04 | done |
| `checks-rules/` | New detector rules (SL008–SL011, SL204–SL205, SL303–SL304, SL401) | T-01..T-07 | done |
