...
- Status: T-01..T-03 done; T-04..T-07 DV-gated (blocked on demand evidence)
- Language: English
- Created: 2026-09-08
...
- Gated tasks (T-04..T-07) ship as specifications; implementation starts
...
| T-05 | Copilot CLI event-stream adapter | P2 | **DV gate** |
