...
| [codes/](codes/README.md) | Per-code documentation for all 32 diagnostic reason codes (SL001–SL402), including the A4 assurance ceiling and the closed coverage-skip vocabulary. |
