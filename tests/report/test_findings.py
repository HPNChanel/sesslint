...
def test_deterministic_finding_sort_order() -> None:
    """Verify findings are sorted deterministically in FR-094 position-first order."""
    ...
    # Expected FR-094 position-first order:
    # 1. f4: a.jsonl, line 5, SL003
    # 2. f3: a.jsonl, line 10, SL001
    # 3. f1: a.jsonl, line 100, SL002
    # 4. f2: b.jsonl, line 50, SL001
    assert sorted_findings == [f4, f3, f1, f2]
    ...
    assert pos_f4 < pos_f3 < pos_f1 < pos_f2
